...
class VipProductView extends StatefulWidget {
  final Producto product;
  const VipProductView({Key? key, required this.product}) : super(key: key);

  @override
  _VipProductView createState() => _VipProductView();
}

class _VipProductView extends State<VipProductView> {
                    ...
                    children: [
                      Column(
                        ...
                        children: [
                          ...
                          Text(
                            "\$ " + widget.product.precio.toString() + '.00',
